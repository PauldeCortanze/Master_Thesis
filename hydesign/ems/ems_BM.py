...
class ems_pp:
    ...
    def compute(self, wind_t, wind_BM_t, solar_t, price_t, price_up_reg_t, price_dwn_reg_t, SO_imbalance_t, b_P, b_E, G_MW, 
                penalty_BM, bi_directional_status, battery_depth_of_discharge, battery_charge_efficiency, peak_hr_quantile, 
                cost_of_battery_P_fluct_in_peak_price_ratio, n_full_power_hours_expected_per_day_at_peak_price, **kwargs):
        wind_t = wind_t
        solar_t = solar_t
        price_t = price_t
        wind_BM_t = wind_BM_t
        ...
        cost_of_battery_P_fluct_in_peak_price_ratio = np.asarray(cost_of_battery_P_fluct_in_peak_price_ratio).item()
        n_full_power_hours_expected_per_day_at_peak_price = np.asarray(n_full_power_hours_expected_per_day_at_peak_price).item()
        ...
        out_keys = ['wind_t_ext', 'wind_BM_t_ext', 'solar_t_ext', 'price_t_ext', 'price_up_reg_t_ext', 'price_dwn_reg_t_ext',
                    'SO_imbalance_t_ext', 'hpp_t', 'hpp_BM_t', 'hpp_curt_t', 'hpp_curt_BM_t', 'price_penalty_BM_t',
                    'P_hpp_up_t', 'P_hpp_dwn_t', 'P_hpp_up_max_t', 'P_hpp_dwn_max_t', 'b_t', 'b_BM_t', 'b_E_SOC_t', 'b_E_SOC_BM_t', 'penalty_t', 'total_curtailment']
        return [outputs[key] for key in out_keys]

class ems(ComponentWrapper):
    def __init__(self, **insta_inp):
        ems_pp_model = ems_pp(**insta_inp)
        super().__init__(
            inputs=[
                ('wind_t', {'desc': 'WPP power time series in DA/ SM', 'shape': [ems_pp_model.N_time], 'units': 'MW'}),
                ('wind_BM_t', {'desc': 'WPP power time series in HA/ BM', 'shape': [ems_pp_model.N_time], 'units': 'MW'}),
                ('solar_t', {'desc': 'PVP power time series', 'shape': [ems_pp_model.N_time], 'units': 'MW'}),
                ('price_t', {'desc': 'Electricity price time series', 'shape': [ems_pp_model.N_time]}),
                ('price_up_reg_t', {'desc': 'Up regulation price time series', 'shape': [ems_pp_model.N_time]}),
                ('price_dwn_reg_t', {'desc': 'Down regulation price time series', 'shape': [ems_pp_model.N_time]}),
                ('SO_imbalance_t', {'desc': 'System operator power imbalance time series', 'shape': [ems_pp_model.N_time]}),
                ...
                ('bi_directional_status', {'desc': 'Status of bi-directional flow from grid'}),
                ('battery_depth_of_discharge', {'desc': 'battery depth of discharge', 'units': 'MW'}),
                ('battery_charge_efficiency', {'desc': 'battery charge efficiency'}),
                ('peak_hr_quantile', {'desc': "Quantile of price time series to define peak price hours (above this quantile). Only used for peak production penalty and for cost of battery degradation."}),
                ('cost_of_battery_P_fluct_in_peak_price_ratio', {'desc': "cost of battery power fluctuations computed as a peak price ratio."}),
                ('n_full_power_hours_expected_per_day_at_peak_price', {'desc': "Penalty occurs if number of full power hours expected per day at peak price are not reached."}),
            ],
            outputs=[
                ('wind_t_ext', {'desc': 'WPP power time series in DA/ SM', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('wind_BM_t_ext', {'desc': 'WPP power time series in HA/ BM', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('solar_t_ext', {'desc': 'PVP power time series', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('price_t_ext', {'desc': 'Electricity price time series', 'shape': [ems_pp_model.life_h]}),
                ('price_up_reg_t_ext', {'desc': 'Up regulation price time series', 'shape': [ems_pp_model.life_h]}),
                ('price_dwn_reg_t_ext', {'desc': 'Down regulation price time series', 'shape': [ems_pp_model.life_h]}),
                ('SO_imbalance_t_ext', {'desc': 'System operator power imbalance time series', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('hpp_t', {'desc': 'HPP power time series in DA/ SM', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('hpp_BM_t', {'desc': 'HPP power time series in HA/ BM', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('hpp_curt_t', {'desc': 'HPP curtailed power time series in DA/ SM', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('hpp_curt_BM_t', {'desc': 'HPP curtailed power time series in HA/ BM', 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('price_penalty_BM_t', {'desc': "penalty price time series for the curtailed DA power", 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('P_hpp_up_t', {'desc': "Up regulation power time series", 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('P_hpp_dwn_t', {'desc': "Down regulation power time series", 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('P_hpp_up_max_t', {'desc': "Maximum up regulation power time series", 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('P_hpp_dwn_max_t', {'desc': "Maximum down regulation power time series", 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('b_t', {'desc': "Battery charge/discharge power time series in DA/ SM", 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('b_BM_t', {'desc': "Battery charge/discharge power time series in HA/ BM", 'shape': [ems_pp_model.life_h], 'units': 'MW'}),
                ('b_E_SOC_t', {'desc': "Battery energy SOC time series", 'shape': [ems_pp_model.life_h + 1]}),
                ('b_E_SOC_BM_t', {'desc': "Battery energy SOC time series", 'shape': [ems_pp_model.life_h + 1]}),
                ('penalty_t', {'desc': "penalty for not reaching expected energy production at peak hours", 'shape': [ems_pp_model.life_h]}),
                ('total_curtailment', {'desc': "total curtailment in the lifetime", 'units': 'GW*h'}),
            ],
            function = ems_pp_model.compute,
...
class ems_long_term_operation_pp:
    ...
    def compute(self, SoH, wind_t_ext_deg, b_P, b_E, battery_depth_of_discharge, battery_charge_efficiency, penalty_BM, hpp_curt_BM_t, b_t,
                 b_BM_t, b_E_SOC_t,P_up_reg_t, P_dwn_reg_t, P_up_max_t, P_dwn_max_t, hpp_t, price_up_reg_t, price_dwn_reg_t, **kwargs):
        ...
        return (outputs['hpp_t_with_deg'], outputs['hpp_curt_t_with_deg'], outputs['b_t_with_deg'], outputs['b_E_SOC_t_with_deg'],
                outputs['penalty_t_with_deg'], outputs['P_up_reg_t_with_deg'], outputs['P_dwn_reg_t_with_deg'], outputs['total_curtailment_deg'])

class ems_long_term_operation(ComponentWrapper):
    def __init__(self, **insta_inp):
        ems_long_term_operation_model = ems_long_term_operation_pp(**insta_inp)
        super().__init__(
            inputs=[
                ('SoH', {'desc': 'Battery state of health at discretization levels', 'shape': [ems_long_term_operation_model.life_h]}),
                ('wind_t_ext_deg', {'desc': 'HA Wind time series with degradation', 'shape': [ems_long_term_operation_model.life_h], 'units': 'MW'}),
                ('b_P', {'desc': 'Battery power capacity', 'units': 'MW'}), 
                ('b_E', {'desc': 'Battery energy storage capacity'}),
                ('battery_depth_of_discharge', {'desc': 'battery depth of discharge', 'units': 'MW'}),
                ('battery_charge_efficiency', {'desc': 'battery charge efficiency'}),
                ('penalty_BM', {'desc': 'penalty for battery management'}),
                ('hpp_curt_BM_t', {'desc': 'High price period curtailment', 'shape': [ems_long_term_operation_model.life_h], 'units': 'MW'}),
                ('b_t', {'desc': 'Battery state of charge', 'units': 'MW', 'shape': [ems_long_term_operation_model.life_h]}),
                ('b_BM_t', {'desc': 'Battery state of health', 'units': 'MW', 'shape': [ems_long_term_operation_model.life_h]}),
                ('b_E_SOC_t', {'desc': 'Battery state of charge', 'shape': [ems_long_term_operation_model.life_h + 1]}),
                ('P_up_reg_t', {'desc': 'Upward regulation power', 'units': 'MW', 'shape': [ems_long_term_operation_model.life_h]}),
                ('P_dwn_reg_t', {'desc': 'Downward regulation power', 'units': 'MW', 'shape': [ems_long_term_operation_model.life_h]}),
                ('P_up_max_t', {'desc': 'Maximum upward power', 'units': 'MW', 'shape': [ems_long_term_operation_model.life_h]}),
                ('P_dwn_max_t', {'desc': 'Maximum downward power', 'units': 'MW', 'shape': [ems_long_term_operation_model.life_h]}),
                ('hpp_t', {'desc': 'High price period', 'units': 'MW', 'shape': [ems_long_term_operation_model.life_h]}),
                ('price_up_reg_t', {'desc': 'Upward price', 'shape': [ems_long_term_operation_model.life_h]}),
                ('price_dwn_reg_t', {'desc': 'Downward price','shape': [ems_long_term_operation_model.life_h]}),
            ],
            outputs=[
                ('hpp_t_with_deg', {'desc': 'HPP power time series with degradation', 'shape': [ems_long_term_operation_model.life_h], 'units': 'MW'}),
                ('hpp_curt_t_with_deg', {'desc': 'HPP curtailment time series with degradation', 'shape': [ems_long_term_operation_model.life_h], 'units': 'MW'}),
                ('b_t_with_deg', {'desc': 'Battery power time series with degradation', 'shape': [ems_long_term_operation_model.life_h], 'units': 'MW'}),
                ('b_E_SOC_t_with_deg', {'desc': 'Battery state of charge time series with degradation', 'shape': [ems_long_term_operation_model.life_h + 1]}),
                ('penalty_t_with_deg', {'desc': 'Penalty time series with degradation', 'shape': [ems_long_term_operation_model.life_h]}),
                ('P_up_reg_t_with_deg', {'desc': 'Upward regulation power time series with degradation', 'shape': [ems_long_term_operation_model.life_h], 'units': 'MW'}),
                ('P_dwn_reg_t_with_deg', {'desc': 'Downward regulation power time series with degradation', 'shape': [ems_long_term_operation_model.life_h], 'units': 'MW'}),
                ('total_curtailment_deg', {'desc': 'Total curtailment with degradation', 'units': 'GW*h'}),
            ],
