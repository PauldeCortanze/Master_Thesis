...
class ems_pp:
    ...
    def compute(self, **inputs):
        ...
        out_keys = ['P_HPP_SM_t_opt', 'SM_price_cleared', 'BM_dw_price_cleared', 'BM_up_price_cleared', 'P_HPP_ts', 'P_HPP_RT_refs', 'P_HPP_UP_bid_ts', 'P_HPP_DW_bid_ts', 's_UP_t', 's_DW_t', 'residual_imbalance', 'P_curtailment_ts', 'P_charge_discharge_ts', 'E_SOC_ts']
        return [outputs[k] for k in out_keys]

class ems(ComponentWrapper):
    def __init__(self, **insta_inp):
        ems_model = ems_pp(**insta_inp)
        super().__init__(
            inputs = [
        ('G_MW',
          dict(units='MW',
        ...
        ('wind_t_da',
            dict(            desc="day ahead power time series at the hub height",
                        units='MW',
                        shape=[ems_model.N_time]),),

        ('wind_t_ha',
           dict(             desc="hour ahead power time series at the hub height",
                        units='MW',
                        shape=[ems_model.N_time]),),

        ('wind_t_rt',
           dict(             desc="real time power time series at the hub height",
                        units='MW',
                        shape=[ems_model.N_time]),),
        ...
        ('solar_t_da',
           dict(             desc="day ahead pv power time series",
                        units='MW',
                        shape=[ems_model.N_time]),),

        ('solar_t_ha',
           dict(             desc="hour ahead pv power time series",
                        units='MW',
                        shape=[ems_model.N_time]),),

        ('solar_t_rt',
           dict(             desc="real time pv power time series",
                        units='MW',
                        shape=[ems_model.N_time]),),
        ...
        # ----------------------------------------------------------------------------------------------------------
        outputs = [
        ('P_HPP_SM_t_opt',dict(desc='',shape=[ems_model.life_intervals],)),
        ('SM_price_cleared',dict(desc='',shape=[ems_model.life_h],)),
        ('BM_dw_price_cleared',dict(desc='',shape=[ems_model.life_h],)),
        ('BM_up_price_cleared',dict(desc='',shape=[ems_model.life_h],)),
        ('P_HPP_ts',dict(desc='',shape=[ems_model.life_intervals],)),
        ('P_HPP_RT_refs',dict(desc='',shape=[ems_model.life_intervals],)),
        ('P_HPP_UP_bid_ts',dict(desc='',shape=[ems_model.life_intervals],)),
        ('P_HPP_DW_bid_ts',dict(desc='',shape=[ems_model.life_intervals],)),
        ('s_UP_t',dict(desc='',shape=[ems_model.life_intervals],)),
        ('s_DW_t',dict(desc='',shape=[ems_model.life_intervals],)),
        ('residual_imbalance',dict(desc='',shape=[ems_model.life_intervals],)),
        ('P_curtailment_ts',dict(desc='',shape=[ems_model.life_intervals],)),
        ('P_charge_discharge_ts',dict(desc='',shape=[ems_model.life_intervals],)),
        ('E_SOC_ts',dict(desc='',shape=[ems_model.life_intervals + 1],)),
        ],
        function=ems_model.compute,
