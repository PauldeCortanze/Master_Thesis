...
class ems_P2X_bidirectional_pp:
    ...
    def compute(self, **inputs):
        ...
        out_keys = ['wind_t_ext', 'solar_t_ext', 'price_t_ext', 'hpp_t', 'hpp_curt_t', 
                    'b_t', 'b_E_SOC_t', 'penalty_t', 'P_ptg_t', 'm_H2_t', 'm_H2_offtake_t', 'LoS_H2_t',
                      'total_curtailment', 'm_H2_demand_t_ext', 'm_H2_storage_t', 'm_H2_grid_t', 'P_ptg_grid_t']
        return [outputs[k] for k in out_keys]

class ems_P2X_bidirectional(ComponentWrapper):
    def __init__(self, **insta_inp):
        ems_model = ems_P2X_bidirectional_pp(**insta_inp)
