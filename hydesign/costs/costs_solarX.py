...
class sf_cost:
    ...
    # def setup(self):
        ...
        # inputs
        self.inputs = [
            ('sf_area', dict(desc="Installed capacity of the solar field", units='m**2'))
        ]
        # outputs
        self.outputs = [
...
class cpv_cost:
    ...
    # def setup(self):
        ...
        # inputs
        self.inputs = [
            ('cpv_inverter_mw', dict(desc="rated power of the cpv inverter", units='MW')),
...
class cst_cost:
    ...
    # def setup(self):
        ...
        # inputs
        self.inputs = [
            ('area_cst_receiver_m2', dict(desc="Area of heat receiver on the tower", units='m**2')),
            ('v_molten_salt_tank_m3', dict(desc="Volume of the molten salt storage", units='m**3')),
            ('p_rated_st', dict(desc="Steam turbine power capacity", units="MW")),
            ('heat_exchanger_capacity', dict(desc='Heat exchnager power capacity', units='MW'))
        ]   
...
class H2Cost:
    ...
    # def setup(self):
        ...
        # inputs
        self.inputs = [
            ('area_el_reactor_biogas_h2', dict(desc='Area of the biogas_h2 electrical reactor', units='m**2')),
            ('area_dni_reactor_biogas_h2', dict(desc='Area of the biogas_h2 dni reactor', units='m**2')),
            ('biogas_t_ext', dict(desc="Biogas consumption time series", units='kg/h', shape=[self.life_h])),
            ('water_t_ext', dict(desc="Water consumption time series", units='kg/h', shape=[self.life_h])),
            ('co2_t_ext', dict(desc="CO2 consumption time series", units='kg/h', shape=[self.life_h])),
            ('p_biogas_h2_t', dict(desc="electricity consumption time series", shape=[self.life_h], units='MW')),
            ('price_el_t_ext', dict(desc="electricity price time series", shape=[self.life_h])),
            ('price_biogas_t_ext', dict(desc="electricity price time series", shape=[self.life_h])),
            ('price_water_t_ext', dict(desc="electricity price time series", shape=[self.life_h])),
            ('price_co2_t_ext', dict(desc="electricity price time series", shape=[self.life_h])),
        ]
...
class shared_cost:
    ...
    # def setup(self):
        ...
        self.inputs = [
            ...
            ('grid_heat_capacity', dict(desc="Grid Heat connection capacity", units='MW')),
