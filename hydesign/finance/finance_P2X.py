...
class finance_P2X_pp:
    ...
    def compute(self, **inputs):
        ...
        out_keys = ['CAPEX', 'OPEX', 'NPV', 'IRR', 'NPV_over_CAPEX', 'mean_AEP', 'annual_H2', 'LCOE', 'LCOH', 'Revenue', 
                    'annual_P_ptg', 'penalty_lifetime', 'break_even_H2_price', 'break_even_PPA_price']
        return [outputs[key] for key in out_keys]

class finance_P2X(ComponentWrapper):
    def __init__(self, **insta_inp):
        finance_model = finance_P2X_pp(**insta_inp)
