...
class hpp_model(hpp_base):
    ...
    def setup_optimization(self, seed=0, PopSize=4, maxGen=1, Pc=0.6, Pm=0.2):
        ...
        # -------------------------------------------------------------------
        # NSGA2 driver (handles multiple objectives natively — Pareto front)
        # -------------------------------------------------------------------
...
def run_optimization_seed(args):
    try:
        ...
        worker_dir = os.path.join(
            base_dir,
            f'Multi_worker_run_Pc{Pc}_Pm{Pm}_seed{seed}_pid{os.getpid()}')
...
if __name__ == "__main__":
    ...
    print(f"Using simulation parameters from {input_ts_fn}")
    ...
    run_optimization_seed((0, 40, 50, 0.6, 0.25, latitude, longitude, altitude,
