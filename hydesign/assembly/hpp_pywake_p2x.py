...
class hpp_model(hpp_base):
    ...
    def __init__(
       ...
       ('battery_loss_comp', ComponentWrapper([('SoH', {'shape': [life_intervals]})],
        ...
        ('ems_long_term_comp', ems_long_term_operation_p2x(N_time=N_time,
                                                            num_batteries = num_batteries,
                                                            life_y = life_y,
                                                            intervals_per_hour = intervals_per_hour,
                                                            # ems_type=ems_type,
        ...
        ('finance_comp', finance_P2X(                N_time = N_time,
        ...
        prob.set_val('n_full_power_hours_expected_per_day_at_peak_price', n_full_power_hours_expected_per_day_at_peak_price)
