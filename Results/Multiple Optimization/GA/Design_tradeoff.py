...
def generate_full_evaluation_plots(csv_path):
    ...
    PopSize = 20
    df["generation"] = df["iteration"] // PopSize
    ...
    for var in design_vars:
        ...
        ax.set_title(
            f"All Function Evaluations colored by Battery Capacity",
            fontsize=14,
            fontweight="bold",
        )
        ...
        # Save plot
        fig.savefig(f"Design/all_evals_scatter_{var}_2.png", dpi=300)
        plt.close(fig)
...
if __name__ == "__main__":
    ...
    csv_file_path = "Results/history_NSGA_seed0_ew0.0.csv"
